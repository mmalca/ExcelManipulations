...
inline double sin2(double x) { return sin(x) * sin(x); }
inline double cos2(double x) { return cos(x) * cos(x); }
inline double tan2(double x) { return tan(x) * tan(x); }
inline double tan4(double x) { return tan2(x) * tan2(x); }
...
//=================================================
inline void itm2wgs84(int N, int E, double& lat, double& lon)
{
...
//=================================================
inline void wgs842itm(double lat, double lon, int& N, int& E)
{
...
//=================================================
inline void ics2wgs84(int N, int E, double& lat, double& lon)
{
...
//=================================================
inline void wgs842ics(double lat, double lon, int& N, int& E)
{
	double latr = lat * pi() / 180;
	double lonr = lon * pi() / 180;
...
//====================================
inline void Grid2LatLon(int N, int E, double& lat, double& lon, gGrid from, eDatum to)
{
	//================
	// GRID -> Lat/Lon
	//================
...
//====================================
inline void LatLon2Grid(double lat, double lon, int& N, int& E, eDatum from, gGrid to)
{
